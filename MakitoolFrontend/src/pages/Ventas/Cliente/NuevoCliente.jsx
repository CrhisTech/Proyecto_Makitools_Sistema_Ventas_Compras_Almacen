...
export default function NuevoCliente() {
    ...
    return (
        <div className="container-fluid" style={{ maxWidth: '900px' }}>
            <h2 className="h3 mb-4 text-gray-800">Registrar Nuevo Cliente</h2>

            <div className="card shadow mb-4">
                <div className="card-header py-3">
                    <h6 className="m-0 font-weight-bold text-primary">Datos del Cliente</h6>
                </div>
                <div className="card-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-md-6">
                                <label className="form-label fw-bold">Apellidos (Opcional si es empresa)</label>
                        ...
                        <div className="row mb-4">
                            <div className="col-md-6">
                                ...
                                <input type="password" name="clave" value={cliente.clave} onChange={handleChange} className="form-control" minLength="6" required />
                        ...
                        <div className="row mt-4">
                            <div className="col-auto">
                                <button type="submit" disabled={guardando} style={{ cursor: guardando ? "wait" : "pointer" }} className="btn btn-primary btn-icon-split">
                                    ...
                                    <span className="text">{guardando ? "Guardando..." : "Guardar Cliente"}</span>
                                </button>
                            </div>
                            <div className="col-auto">
