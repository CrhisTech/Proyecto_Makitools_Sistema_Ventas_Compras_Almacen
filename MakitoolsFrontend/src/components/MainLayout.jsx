...
export default function MainLayout() {
  ...
  return (
    // 1. EL WRAPPER PRINCIPAL (d-flex asegura que Sidebar y Content estén lado a lado)
    <div id="wrapper" className="d-flex" style={{ minHeight: "100vh" }}>
      ...
      >
        ...
        {/* MANTENIMIENTO: Lo ve el Admin (1) y el área de Almacén (7,8,9) */}
        {[1, 7, 8, 9].includes(idRolUsuario) && (
          <>
        ...
        {[1, 4, 7].includes(idRolUsuario) && (
                <>
                  <div className="sidebar-heading mt-3">Abastecimiento</div>

                  <li
                    className={`nav-item ${location.pathname.includes("/compras") ? "active" : ""}`}
                  >
                    <Link
              ...
              <li className="nav-item dropdown no-arrow">
                ...
                >
                  <span className="me-3 d-none d-lg-inline text-gray-600 small fw-bold">
                    crhistophercapcha@gmail.com <br />
                    <small className="text-primary">Admin General</small>
                  </span>
